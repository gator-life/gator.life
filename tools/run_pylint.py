...
COMMAND = 'pylint src/server/server src/scraper/scraper src/common/common src/topicmodeller/topicmodeller src/learner/learner -f parseable'
TEST_COMMAND = 'pylint --rcfile=pylintrc_tests src/server/tests/*.py src/scraper/tests/*.py src/common/tests/*.py src/functests/*.py src/topicmodeller/tests/*.py src/learner/tests/*.py -f parseable'
