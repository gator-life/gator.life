...
class UserProfileBuilderTests(unittest.TestCase):
    ...
    def test_update_all_user_profiles_in_database(self):
        user1 = struct.User.make_from_scratch(email='user1-test_update_user_profiles_in_database', password='password1',
                                              interests='interests1')
        user2 = struct.User.make_from_scratch(email='user2-test_update_user_profiles_in_database', password='password2',
